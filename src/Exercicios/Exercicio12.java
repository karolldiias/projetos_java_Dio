...
public class Exercicio12 {
   ...
   * comercializados em um cinema.
   * O ingresso deve ter um valor, nome do filme e informar se é dublado ou
   * legendado. A partir desse ingresso devem ser criados os tipos
   * Meia entrada e ingresso família. Cada ingresso deve ter um método que retorna
   ...
   * ingressos família deve-se retornar o valor multiplicado pelo número de
   * pessoas e
