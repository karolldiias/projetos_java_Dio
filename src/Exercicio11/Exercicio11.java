...
public class Exercicio11 {
  ...
  public static void main(String[] args) {
    ...
    do {
      ...
      System.out.println("5 - Verificar a shampoo da máquina");
  ...
  private static void verifyShampoo() {
    ...
    System.out.println("A máquina esta no momento com" + amount + " litros(s) de shampoo");
  }

  private static void verifyWater() {
    var amount = petMachine.getWater();
    System.out.println("A máquina esta no momento com" + amount + " litros(s) de água");
  }
